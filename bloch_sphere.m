...
% initial state 
coefficients = [0.8, 0.6i];
initial_state = quantum.gate.QuantumState(coefficients);
initial_amplitudes = initial_state.Amplitudes;
disp("Initial amplitudes for circuit 1:");
disp(initial_amplitudes);

circuit = quantumCircuit(xGate(1));
output_state = simulate(circuit, initial_state);
output_amplitudes = output_state.Amplitudes;
disp("Output amplitudes from X gate:");
disp(output_amplitudes);

figure(1);
tiledlayout(1, 2);
nexttile
plotBlochSphere(initial_amplitudes);
nexttile
plotBlochSphere(output_amplitudes);
hold on
...
initial_state = quantum.gate.QuantumState(coefficients);
initial_amplitudes = initial_state.Amplitudes;
disp("Initial amplitudes for circuit 2:");
disp(initial_amplitudes);

circuit = quantumCircuit(yGate(1));
output_state = simulate(circuit, initial_state);
output_amplitudes = output_state.Amplitudes;
disp("Output amplitudes from Y gate:");
disp(output_amplitudes);
...
initial_state = quantum.gate.QuantumState(coefficients);
initial_amplitudes = initial_state.Amplitudes;
disp("Initial amplitudes for circuit 3:");
disp(initial_amplitudes);

circuit = quantumCircuit(zGate(1));
output_state = simulate(circuit, initial_state);
output_amplitudes = output_state.Amplitudes;
disp("Output amplitudes from Z gate:");
disp(output_amplitudes);
